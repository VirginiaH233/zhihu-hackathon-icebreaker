...
1. **找人** —— 输入昵称 / 主页后缀（如 `chenqin`）/ 主页链接。知乎开放平台**没有「搜人」接口**，所以按主页找人这一条走知乎网页版免鉴权接口。
2. **读 TA** —— 读 TA 的公开创作（回答 / 文章 / 想法），整理成一份**灵魂档案**：核心关切、观点倾向、表达风格、价值排序。
3. **建你的分身（可选）** —— 用你自己的知乎账号授权，只读你本人的公开创作。档案可以逐条改——AI 给你画的像，你有权利改。
4. **你本人上场** —— 跟 TA 的分身聊。它每条发言都带**依据标签**，点开能看到 TA 的原话；你可以追问、反驳、把它逼到墙角。
